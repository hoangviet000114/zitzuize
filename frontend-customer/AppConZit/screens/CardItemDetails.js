      ...
      <HeaderImageScrollView
        ...
        renderForeground={() => (
          <View style={styles.titleContainer}>
            <Text style={styles.imageTitle}>{itemData.ten_cuahang}</Text>
          </View>
        )}
        renderFixedForeground={() => (
          <Animatable.View style={styles.navTitleView} ref={navTitleView}>
            <Text style={styles.navTitle}>{itemData.ten_cuahang}</Text>
          </Animatable.View>
        )}>
        <TriggeringView
        ...
        <View style={[styles.section, styles.sectionLarge]}>
          <Text style={styles.sectionContent}>{itemData.mo_ta}</Text>
        </View>

        <View style={styles.section}>
          <View style={styles.categories}>
            {listCate.map((listCate, index) => (
              <View style={styles.categoryContainer} key={index}>
                <FontAwesome name="tag" size={16} color="#fff" />
                <Text style={styles.category}>{listCate.ten_loaidoan}</Text>
              </View>
            ))}
          </View>
        </View>
